		...
		do {
			...
			case 1:
				if (numeroEquipos < NUMEROEQUIPOS) {
					...
					System.out.println("Número máximo de equipos alcanzados.");
			...
			case 5:
				...
				if (!encontrado)
					System.out.println("Los equipo introducidos no existen.");
					...
					System.out.println("Número máximo de partidos jugados.");
